// modules/ai-agent/tests/intentRouter.test.js
import { detectIntent } from "../core/IntentRouter.js";
...
if (failed === 0) {
  console.log("🎉 TẤT CẢ TEST CASES ĐÃ VƯỢT QUA XUẤT SẮC!\n");
  process.exit(0);
} else {
  console.error("⚠️ CÓ TEST CASE BỊ THẤT BẠI, CẦN KIỂM TRA LẠI TỪ KHÓA ROUTER!\n");
  process.exit(1);
}
